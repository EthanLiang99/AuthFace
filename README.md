...
The dataset is organized as follows. For the `man` subset, we also provide `.json` files (generated by **Qwen**) containing detailed textual descriptions or attributes corresponding to the images.
